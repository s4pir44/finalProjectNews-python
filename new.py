...
#    print(responses)
    ...
    print(news)
    try:
        aux = pd.read_csv(r'C:\PycharmProjects\TestProject\news.csv', encoding='windows-1252')
    except:
        print("Unexpected error:", sys.exc_info()[0])
        aux = pd.DataFrame(columns=list(news.columns))
        aux.to_csv(r'C:\PycharmProjects\TestProject\news.csv', encoding='windows-1252', index=False)

    with open(r'C:\PycharmProjects\TestProject\news.csv', 'a', encoding='windows-1252', errors='ignore') as f:
        news.to_csv(f, header=False, encoding='windows-1252', index=False)

    cleanData(r'C:\PycharmProjects\TestProject\news.csv')
    print('Done')
